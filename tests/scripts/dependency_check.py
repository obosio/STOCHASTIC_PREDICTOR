...
Output:
    ...
    - JSON report: tests/results/dependency_check_last.json
    - Markdown report: tests/reports/dependency_check_last.md
...
def load_requirements(root: Path, platform_info: Dict[str, str]) -> Dict[str, str]:
    """Load requirements.txt and filter for current platform.
