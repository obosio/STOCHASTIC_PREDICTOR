...
The mutation protocol integrates with the tiered optimization framework (Deep Tuning + Fast Tuning) defined in \dochref{specification/Stochastic_Predictor_Implementation}{Stochastic\_Predictor\_Implementation.tex}:
