...
sinkhorn_max_iter: int = 200       # Max Sinkhorn iterations
sinkhorn_inner_iterations: int = 10 # Inner log-domain iterations
\end{lstlisting}
...
entropy_volatility_low_threshold: float = 0.05
entropy_volatility_high_threshold: float = 0.2
entropy_ratio_min: float = 0.1
entropy_ratio_max: float = 10.0
entropy_baseline_floor: float = 1e-6
mode_collapse_min_threshold: int = 10
mode_collapse_window_ratio: float = 0.1
\end{lstlisting}

\subsubsection{Adaptive Coupling and Stiffness}
\begin{lstlisting}[language=Python]
dgm_entropy_coupling_beta: float = 0.7  # DGM entropy-topology coupling
dgm_max_capacity_factor: float = 4.0   # Max width*depth multiplier
stiffness_calibration_c1: float = 25.0 # Calibration constant (low)
stiffness_calibration_c2: float = 250.0 # Calibration constant (high)
...
telemetry_adaptive_log_path: str = "io/adaptive_telemetry.jsonl"
telemetry_adaptive_window_size: int = 100
telemetry_placeholder_max_stiffness_metric: float = 0.0
telemetry_placeholder_num_internal_iterations_mean: float = 0.0
telemetry_placeholder_implicit_residual_norm_max: float = 0.0
telemetry_dashboard_title: str = "USP Telemetry Dashboard"
telemetry_dashboard_width: int = 720
telemetry_dashboard_height: int = 180
telemetry_dashboard_spread_epsilon: float = 1e-9
telemetry_dashboard_recent_rows: int = 25
frozen_signal_min_steps: int = 5
frozen_signal_recovery_ratio: float = 0.1
frozen_signal_recovery_steps: int = 2
frozen_signal_variance_floor: float = 1e-12
...
log_sig_depth = 3
kernel_d_depth = 3
kernel_d_load_shedding_depths = [2, 3, 5]
kernel_d_alpha = 0.1
...
pdf_grid_min_z = -4.0
pdf_grid_max_z = 4.0
pdf_grid_num_points = 256
pdf_min_sigma = 1e-6
confidence_interval_z = 1.96
kernel_output_time_us = 1.0
kurtosis_min = 1.0
kurtosis_max = 100.0
kurtosis_reference = 3.0
...
\begin{itemize}
    ...
    \item \textbf{Determinism}: Uses config-driven PRNG seed for reproducible compilation
...
from Python.api.warmup import warmup_with_retry
from Python.api.config import PredictorConfigInjector
...
from Python.api.types import InternalState
...
from Python.api.state_buffer import atomic_state_update
