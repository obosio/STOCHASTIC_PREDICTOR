...
holder_exponent_current = float(output_a.metadata["holder_exponent"])
...
entropy_ratio = compute_entropy_ratio(entropy_current, float(state.baseline_entropy))
...
fusion_config = replace(config, learning_rate=adaptive_learning_rate, entropy_window=adaptive_entropy_window)
\end{lstlisting}
