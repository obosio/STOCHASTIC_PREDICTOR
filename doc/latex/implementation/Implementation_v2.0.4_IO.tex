...
To eliminate magic numbers in PRNG splitting, we introduce a module-level constant:
...
This ensures clarity and maintainability.
...
\begin{itemize}
    ...
    \item \textbf{PRNG Constants}: Named constants replace magic numbers
\end{itemize}
