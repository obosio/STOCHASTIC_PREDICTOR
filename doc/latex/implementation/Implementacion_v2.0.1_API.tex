...
\begin{itemize}
    ...
    \item \textbf{Auditor\'ia}: Si \texttt{USP\_AUDIT\_LOG\_PATH} est\'a definido, se emite un registro JSONL con tiempos por kernel y total
\end{itemize}
...
\paragraph{Auditor\'ia opcional}
Si \texttt{USP\_AUDIT\_LOG\_PATH} est\'a definido, el perfil de warm-up se registra en formato JSONL con el evento \texttt{warmup\_profile}, el contexto de ejecuci\'on y las m\'etricas en milisegundos.
