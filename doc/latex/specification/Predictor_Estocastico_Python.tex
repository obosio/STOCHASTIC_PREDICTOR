...
\begin{itemize}
    ...
    \item \textbf{Equinox 0.11.3 → 0.11.4}: Ajuste en inicialización de pesos de redes neuronales (Rama B DGM) cambia valores de predicción
\end{itemize}
...
equinox==0.11.3          # Neural ODEs (Rama C)
