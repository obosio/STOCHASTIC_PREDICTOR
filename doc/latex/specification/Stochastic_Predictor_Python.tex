...
\textbf{JAX 0.4.20} is the foundational layer. It provides:
\begin{itemize}
...
\subsection{Equinox 0.11.2: Neural Framework}
...
\subsection{Diffrax 0.4.1: ODE/SDE Solvers}
...
\subsection{Signax 0.1.4: Log-Signatures}
...
\subsection{OTT-JAX 0.4.5: Differentiable Optimal Transport}
...
\hline
Compute core & JAX & 0.4.20 & XLA, AD, vmap, jit \\
Neural models & Equinox & 0.11.2 & DGM (Branch B) \\
ODE/SDE solvers & Diffrax & 0.4.1 & Branch C \\
Signatures & Signax & 0.1.4 & Branch D \\
Optimal Transport & OTT-JAX & 0.4.5 & JKO orchestrator \\
Wavelets & PyWavelets & 1.4.1 & WTMM (SIA) \\
\hline
\end{tabular}
\end{table}
