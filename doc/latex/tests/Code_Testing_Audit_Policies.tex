...
\begin{itemize}[noitemsep]
    \item \filehref{doc/latex/specification/Stochastic\_Predictor\_Theory.tex}
    \item \filehref{doc/latex/specification/Stochastic\_Predictor\_Implementation.tex}
    \item \filehref{doc/latex/specification/Stochastic\_Predictor\_IO.tex}
    \item \filehref{doc/latex/specification/Stochastic\_Predictor\_API\_Python.tex}
    \item \filehref{doc/latex/specification/Stochastic\_Predictor\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} (Configuration Mutation Protocol) and \dochref{specification/Stochastic_Predictor_API_Python}{Stochastic\_Predictor\_API\_Python.tex} (PredictorConfig)
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} (Invariant Protection)
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} (Validation Schema)
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} (Atomic TOML Update Algorithm)
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} (Rate Limiting and Safety Guardrails)
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Implementation}{Stochastic\_Predictor\_Implementation.tex} and \dochref{specification/Stochastic_Predictor_Tests_Python}{Stochastic\_Predictor\_Tests\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Implementation}{Stochastic\_Predictor\_Implementation.tex} and \dochref{specification/Stochastic_Predictor_Python}{Stochastic\_Predictor\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Implementation}{Stochastic\_Predictor\_Implementation.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Implementation}{Stochastic\_Predictor\_Implementation.tex} and \dochref{specification/Stochastic_Predictor_Test_Cases}{Stochastic\_Predictor\_Test\_Cases.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Python}{Stochastic\_Predictor\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Python}{Stochastic\_Predictor\_Python.tex} (kernels are pure XLA kernels)
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} and \dochref{specification/Stochastic_Predictor_Test_Cases}{Stochastic\_Predictor\_Test\_Cases.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} and \dochref{specification/Stochastic_Predictor_Tests_Python}{Stochastic\_Predictor\_Tests\_Python.tex}
...
\textbf{Policy Statement:}
Credentials must be injected via environment variables. No secrets in source, config, or logs. \filehref{.env} must be gitignored.

\subsection{Policy \#19: Snapshot Integrity (SHA-256) and Validation}

\textbf{Source:} \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex} and \dochref{specification/Stochastic_Predictor_API_Python}{Stochastic\_Predictor\_API\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Theory}{Stochastic\_Predictor\_Theory.tex} and \dochref{specification/Stochastic_Predictor_Tests_Python}{Stochastic\_Predictor\_Tests\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Theory}{Stochastic\_Predictor\_Theory.tex} and \dochref{specification/Stochastic_Predictor_Test_Cases}{Stochastic\_Predictor\_Test\_Cases.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_API_Python}{Stochastic\_Predictor\_API\_Python.tex} and \dochref{specification/Stochastic_Predictor_Tests_Python}{Stochastic\_Predictor\_Tests\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_API_Python}{Stochastic\_Predictor\_API\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Tests_Python}{Stochastic\_Predictor\_Tests\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_Test_Cases}{Stochastic\_Predictor\_Test\_Cases.tex} and \dochref{specification/Stochastic_Predictor_Tests_Python}{Stochastic\_Predictor\_Tests\_Python.tex}
...
\textbf{Source:} \dochref{specification/Stochastic_Predictor_API_Python}{Stochastic\_Predictor\_API\_Python.tex} and \dochref{specification/Stochastic_Predictor_IO}{Stochastic\_Predictor\_IO.tex}
...
\begin{itemize}[noitemsep]
    \item \filehref{tests/scripts/code\_alignement.py} - 36 CODE\_AUDIT\_POLICIES
    \item \filehref{tests/scripts/scope\_discovery.py} - Auto-discovery utilities
\end{itemize}
