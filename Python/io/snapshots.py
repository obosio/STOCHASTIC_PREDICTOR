...
def serialize_state(state: InternalState) -> Dict[str, Any]:
    return {
        ...
        "residual_window": _encode_array(state.residual_window),
        ...
        "adaptive_h_t": _encode_array(state.adaptive_h_t),
        ...
        "mode_collapse_consecutive_steps": int(state.mode_collapse_consecutive_steps),
        "degraded_mode_recovery_counter": int(state.degraded_mode_recovery_counter),
        "baseline_entropy": _encode_array(state.baseline_entropy),
        "solver_explicit_count": int(state.solver_explicit_count),
        "solver_implicit_count": int(state.solver_implicit_count),
        "architecture_scaling_events": int(state.architecture_scaling_events),
...
def deserialize_state(payload: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "residual_window": _decode_array(payload["residual_window"]),
        ...
        "adaptive_h_t": _decode_array(payload["adaptive_h_t"]),
        ...
        "mode_collapse_consecutive_steps": int(payload["mode_collapse_consecutive_steps"]),
        "degraded_mode_recovery_counter": int(payload["degraded_mode_recovery_counter"]),
        "baseline_entropy": _decode_array(payload["baseline_entropy"]),
        "solver_explicit_count": int(payload["solver_explicit_count"]),
        "solver_implicit_count": int(payload["solver_implicit_count"]),
        "architecture_scaling_events": int(payload["architecture_scaling_events"]),
